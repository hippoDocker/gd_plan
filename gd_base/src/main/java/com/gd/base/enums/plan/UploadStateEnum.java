...
/**
 * @program: gd_plan
 * @description: TODO 上传状态枚举
 * @author: tangxl
 * @create: 2022-03-05 14:25
 */
public enum UploadStateEnum {
	UPLOAD_STATE_ZERO(0L,"未上传"),
	UPLOAD_STATE_ONE(1L,"已上传");
	...
	UploadStateEnum(Long type,String typeName){
		this.type = type;
	...
	public static Long getTypeByTypeName(String typeName){
		Long result = 1L;
		for (UploadStateEnum item : values()){
